...
<div id="divshow1"><s:url id="remoteurl"
	...
	action="json-list-purchese2-staff" /> <sjg:grid id="gridedittable"
	caption="รายการขาย" dataType="json" href="%{remoteurl}" pager="true"
	navigator="true" editurl="%{editurl}" navigatorDelete="true"
	...
	<sjg:gridColumn name="orderId" index="orderId" title="sale order ID"
		width="100" formatter="integer" sortable="true" />
