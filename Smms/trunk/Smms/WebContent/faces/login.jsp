...
<link rel="stylesheet" href="/Smms/struts/themes/dark-hive/jquery-ui.css" type="text/css"/><sj:head locale="th" jqueryui="true" jquerytheme="dark-hive" />
...
<sj:div id="result1" class="page_margins">
	<div class="page">
	...
	<s:form id="formValidateCustom" action="login" theme="simple"
		...
		<div class="type-button"><sj:submit targets="result1"
	...
	</s:form> <img id="indicator" src="images/indicator.gif" alt="Loading..."
