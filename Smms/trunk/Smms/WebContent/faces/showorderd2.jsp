...
<div id="divshow2"><s:url id="remoteurl"
	action="json-list-order-cancel-staff" /> <!-- ShowOrdered --> <s:url
	id="subgridurl" action="json-list-purchese2-staff" /> <sjg:grid
	id="gridedittable" caption="รายการสั่งชื้อที่ถูกยกเลิก" dataType="json"
	...
	<sjg:gridColumn name="orderId" index="orderId" title="sale order ID"
		formatter="integer" sortable="true" width="100" />
