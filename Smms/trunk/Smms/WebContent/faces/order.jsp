 ...
 <s:url id="remoteurl" action="jsonorder" />
    ...
    >
       <sjg:gridColumn name="id" index="id" title="sale order ID" formatter="integer" sortable="false" width="200"/>
    	...
    	<sjg:gridColumn name="productCode" index="productCode" title="รหัส ผลิตภัณฑ์" sortable="false" width="200"/>
    	<sjg:gridColumn name="productName" index="productName" title="ชื่อ ผลิตภัณฑ์" sortable="false" width="200"/>
    	<sjg:gridColumn name="productDetail" index="productDetail" title="รายละเอียด ผลิตภัณฑ์" sortable="false" width="320"/>
    	...
    	<sjg:gridColumn name="commision" index="commision" title="ราคารวม" sortable="false" />
    	<sjg:gridColumn name="totalPV" index="totalPV" title="Total SV" formatter="integer" sortable="false" width="200"/>
      </sjg:grid>
    </sj:div>
    </sj:div>
    </td>
