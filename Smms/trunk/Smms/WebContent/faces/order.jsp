...
<sj:div id="div4">
	<table
		...
		<tr>
			...
			<td><sj:div id="div0">
				<sj:div id="div2">
					<s:url id="remoteurl" action="json-list-order1-member" />
					<!-- ShowOrdered -->
					<s:url id="subgridurl" action="json-list-purchese1-member" />
					<sjg:grid id="gridedittable" caption="รายการสั่งชื้อ"
						dataType="json" href="%{remoteurl}" pager="true" navigator="true"
						navigatorSearch="false" navigatorDelete="false"
						navigatorAdd="false" navigatorEdit="false" gridModel="gridModel"
						rowList="15,30" rowNum="15" width="880" rownumbers="false">
						<sjg:grid id="subgridtable1" subGridUrl="%{subgridurl}"
							caption="+" dataType="json" gridModel="gridModel" rowNum="0"
							footerrow="true" rownumbers="1" width="750">
							...
							<sjg:gridColumn name="quantity" title="จำนวน" formatter="integer" />
